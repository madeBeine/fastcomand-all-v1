      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
          ...
          <div className="bg-gradient-to-br from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-3xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-8 backdrop-blur-sm">
            ...
            <div className="h-64 bg-gradient-to-br from-blue-50 to-blue-100/30 dark:from-blue-900/10 dark:to-blue-800/5 rounded-2xl flex items-center justify-center border border-blue-200/30 dark:border-blue-700/20">
          ...
          <div className="bg-gradient-to-br from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-3xl shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-8 backdrop-blur-sm">
            ...
            <div className="h-64 bg-gradient-to-br from-purple-50 to-purple-100/30 dark:from-purple-900/10 dark:to-purple-800/5 rounded-2xl flex items-center justify-center border border-purple-200/30 dark:border-purple-700/20">
              <div className="text-center">
