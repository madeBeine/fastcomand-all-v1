  ...
  React.useEffect(() => {
    if (meetings.length === 0) {
      ...
      addMeeting({
        ...
        owner: 'أحمد بن زين',
        summary: 'مراجعة أداء الربع الأول ومناقشة الميزانية.',
        status: 'open',
        participants: 7,
        date: now,
        durationMinutes: 90,
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4 lg:p-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
        ...
        <div className="flex items-center gap-2">
          <button onClick={createMeeting} className="px-3 py-2 bg-brand-blue text-white rounded-md shadow-sm">اجتماع جديد</button>
        </div>
      </div>
